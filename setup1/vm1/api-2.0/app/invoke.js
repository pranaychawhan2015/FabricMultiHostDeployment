...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, username, org_name, transientData) => {
    try {
        ...
        if (fcn === "createCar" || fcn === "createPrivateCarImplicitForOrg1"
            ...
            let difference = new Date().getSeconds() - date1.getSeconds();
            message = `Successfully added the car asset with key ${args[0]}, time required for execution is ${difference} seconds`
